                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex justify-center">
                                            ...
                                            <a href="{{ route('nucleos.show', $nucleo->id) }}" class="bg-green-500 dark:bg-green-700 hover:bg-green-600 dark:hover:bg-green-800 text-white font-bold py-2 px-4 rounded mr-2">Mostrar</a>
